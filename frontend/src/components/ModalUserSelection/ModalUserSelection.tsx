...
const UserSelectionModal: React.FC<UserSelectionModalProps> = ({
    ...
    const filterUsers = (term: string) => {
        const filtered = allUsers.filter((user) => {
            const isAlreadyParticipant = project.participants.some((participant) => participant.user_id === user.id);
            const isAlreadyInitiator = project.initiators.some((initiator) => initiator.user_id === user.id);
